...
class qtype_essay_edit_form extends question_edit_form {
    ...
    protected function definition_inner($mform) {
        ...
        $options = get_max_upload_sizes(0, 0, $maxbytes);
        $mform->addElement('select', 'maxbytes', get_string('maxbytes', 'qtype_essay'), $options);
        $mform->setDefault('maxbytes', $maxbytes);
        $mform->addHelpButton('maxbytes', 'maxbytes', 'qtype_essay');
