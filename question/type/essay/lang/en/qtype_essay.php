...
$string['maxbytes_desc'] = 'Default maximum submission file size for all essay questions on the site (subject to course limits)';
$string['maxbytes_help'] = 'Default maximum submission file size for all essay questions on the site (subject to course limits)';
