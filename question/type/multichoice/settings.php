...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_configselect('qtype_multichoice/showstandardinstruction',
            new lang_string('showstandardinstruction', 'qtype_multichoice'),
            new lang_string('showstandardinstruction_desc', 'qtype_multichoice'), 0, $yesno));
