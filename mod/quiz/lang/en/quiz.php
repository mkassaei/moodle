...
$string['addingquizsection'] = 'Adding a section to the quiz';
...
$string['addasectionheading'] = 'Add a section heading';
...
$string['editingquizsection'] = 'Editinging quiz section';
...
$string['quizsection'] = 'Quiz section';
$string['quizsectionheading'] = 'Quiz section heading';
...
$string['sectionheading'] = 'Section heading for {$a}';
$string['sectionheadingnoempty'] = 'Quiz section heading cannot be empty';
